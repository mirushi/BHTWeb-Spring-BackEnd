...
public class PostBusinessConstant {
    ...
    public static final int CONTENT_HTML_MIN = 5;
    public static final int CONTENT_HTML_MAX = 1500000;

    public static final int CONTENT_TEXT_MIN = 5;
    public static final int CONTENT_TEXT_MAX = 30000;

    public static final int TAG_MAX_PER_POST = 5;

    public static final int ADMIN_FEEDBACK_MIN = 5;
    public static final int ADMIN_FEEDBACK_MAX = 300;
